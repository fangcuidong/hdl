	...
	<div class="order">
		...
		<div class="older_top">
			<van-tabs v-model="active" line-height="0">
				<van-tab title="外送">
					<older-outside :user_address="user_address"></older-outside>
...
<script>
import olderOutside from "../../components/older/olderOutside.vue";
import commodity from "../../components/older/commodity.vue";
import optional from "../../components/older/Optional.vue";
import arrive from "../../components/older/arrive.vue";
